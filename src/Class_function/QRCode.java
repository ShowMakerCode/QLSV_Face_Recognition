...
import Class_Core.LoginForm;
import Class_Core.MainForm;
...
public class QRCode extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    private void initComponents() {
        ...
        result_field.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, 240, 220));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/backover.png"))); // NOI18N
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 50, 30));
    ...
    private void initWebcam() {
        ...
        jPanel2.add(panel, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, -39, 300, 300));
    ...
    public void run() {
        do {
            ...
            if (result_field.getText().trim().equals("godoftoolcodedongduong:taikhoanfpt")) {
                dispose();
                MyMessage.msgTrue(" Good day sir"
                        + "\n Manager: Đồng Thái Dương"
                        + "\n Welcome you back");
                mainForm = new MainForm();
                Auth.user = new NhanVien("fpt", "123", "Đồng Thái Dương", true);
